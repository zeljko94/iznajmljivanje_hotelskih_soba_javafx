...
public class AdminPregledSobaController implements Initializable {
    ...
    public void btnDodajOnClick(ActionEvent e){
        ...
        Parent root;
        try {
            root = FXMLLoader.load(getClass().getClassLoader().getResource("iznajmljivanjehotelskihsoba/views/AdminDodajSobu.fxml"));

            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("Admin - Dodaj sobu");
            stage.show();
    ...
    public void btnIzmjeniOnClick(ActionEvent e){
        ...
        if(soba != null){
            ...
            Parent root;
            try {
                root = FXMLLoader.load(getClass().getClassLoader().getResource("iznajmljivanjehotelskihsoba/views/AdminIzmjenaSobe.fxml"));

                Scene scene = new Scene(root);
                stage.setScene(scene);
                stage.setTitle("Admin - Izmjeni sobu");
                stage.show();
            } catch (IOException ex) {
                Logger.getLogger(LoginController.class.getName()).log(Level.SEVERE, null, ex);
            }
